...
export default function ProfileScreen(){
    ...
    return(
        <ContainerDefault>
            ...
            <CustomContainer marginTop={72} backgroundColor={theme.colors.background300} display="flex" flexDirection="column" borderRadius={19} paddingHorizontal={24}>
                <Button backgroundColor="transparent" display="flex" flexDirection="row" width={"100%"} justifyContent="space-between" paddingVertical={24} alignItems="center">
                    <CustomContainer gap={12} flexDirection="row">
                        <HeartProfileIcon/>
                        <ButtonText fontSize="lg" weight="medium">Favoritos</ButtonText>
                    </CustomContainer>
                ...
                <Button backgroundColor="transparent" display="flex" flexDirection="row" width={"100%"} justifyContent="space-between" paddingVertical={24} alignItems="center">
                    <CustomContainer gap={12} flexDirection="row">
                        ...
                        <ButtonText fontSize="lg" weight="medium">Histórico de pedidos</ButtonText>
                    </CustomContainer>
                    <RightArrowProfileIcon/>
                </Button>
            </CustomContainer>

            <CustomContainer marginTop={42} backgroundColor={theme.colors.background300} display="flex" flexDirection="column" borderRadius={19} paddingHorizontal={24}>
            <Button backgroundColor="transparent" display="flex" flexDirection="row" width={"100%"} justifyContent="space-between" paddingVertical={24} alignItems="center">
                    <CustomContainer gap={12} flexDirection="row">
                        <DoorProfileIcon/>
                        <ButtonText fontSize="lg" weight="medium">Sair</ButtonText>
                    </CustomContainer>
                    <RightArrowProfileIcon/>
                </Button>
            </CustomContainer>
