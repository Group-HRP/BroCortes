...
const getFontFamily = (
  ...
  if (fontFamily) {
    return isTitle 
      ? theme.fonts.heading[fontFamily as keyof FontFamilyHeading] || theme.fonts.heading.bold
      : theme.fonts.body[fontFamily as keyof FontFamilyBody] || theme.fonts.body.regular;
  }
...
const getFontSize = (
  ...
  isTitle: TypographyProps['isTitle'],
  theme: { fonts: { sizesBody: FontSizesBody; sizesHeading: FontSizesHeading } }
) => {
